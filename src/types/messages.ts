 ...
 */
export function createPromptMessage(payload: PromptPayload): PromptEnvelope {
 ...
 */
export function createSdkMessage(payload: SdkMessagePayload): SdkMessageEnvelope {
 ...
 */
export function isResultMessage(message: AnyMessage): message is ResultEnvelope {
